...
public extension Matrix4x4 {
    ...
    public static func ==(lhs: Matrix4x4, rhs: Matrix4x4) -> Bool {
        ...
        if !lhs.m34.isEqual(to: rhs.m34) {
            return false
        }

        if !lhs.m41.isEqual(to: rhs.m41) {
            return false
        }

        if !lhs.m42.isEqual(to: rhs.m42) {
            return false
        }

        if !lhs.m43.isEqual(to: rhs.m43) {
            return false
        }

        if !lhs.m44.isEqual(to: rhs.m44) {
            return false
        }
